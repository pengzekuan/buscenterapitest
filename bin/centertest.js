...
var Writable = __webpack_require__(168).Writable;
var debug = __webpack_require__(156)('follow-redirects');
...
exports.CENTER_DOMAIN = 'http://bus.test.gezher.com';

exports.CENTER_ACCESS = exports.CENTER_DOMAIN + '/station/access';

exports.TEST_LOGIN = exports.CENTER_DOMAIN + '/test/login';

exports.CENTER_SITES = exports.CENTER_DOMAIN + '/sites';

exports.WECHAT_NOTIFY = exports.CENTER_DOMAIN + '/wechat/pay/notify';

exports.ORDER_APPLY = exports.CENTER_DOMAIN + '/user/order/apply';

exports.ORDER_COMMIT = exports.CENTER_DOMAIN + '/user/order/commit';

exports.ORDER_PAY = exports.CENTER_DOMAIN + '/wechat/pay';

exports.ORDER_REFUND_APPLY = exports.CENTER_DOMAIN + '/user/order/refund/apply';

exports.ORDER_REFUND = exports.CENTER_DOMAIN + '/user/order/refund/done';

exports.ORDER_CANCEL = exports.CENTER_DOMAIN + '/user/order/cancel';
...
var spawn = __webpack_require__(164).spawn;
var readlink = __webpack_require__(158).readlinkSync;
...
var co = __webpack_require__(134);
var moment = __webpack_require__(0);
var axios = __webpack_require__(133);
var json2xml = __webpack_require__(136);
var api = __webpack_require__(132);
var program = __webpack_require__(135);
...
program
  .version('0.0.1')
  .usage('[options]')
  .option('-c, --cancel', 'Cancel order you create.')
  .option('-u, --host <host>', 'host')
  .parse(process.argv);
...
co(function * () {
  ...
  var classes = classesRes.data.tickets;
  ...
  var payRes = yield axios.post(ORDER_PAY, {
    data: {
      ...
      body: '班次：' + classBuy.id + '线路：' + classBuy.line
    }
  });
  if(!payRes.data.success) {
    throw new CenterException('生成支付链接失败：' + payRes.data.retMessage);
  }
...
module.exports = {
	"_args": [
		[
			...
			"/Users/pengzekuan/Develop/bus-api-check"
		]
	],
	"_from": "axios@latest",
	"_id": "axios@0.16.0",
	...
	"_shrinkwrap": null,
	"_spec": "axios",
	"_where": "/Users/pengzekuan/Develop/bus-api-check",
	"author": {
		"name": "Matt Zabriskie"
	},
	"browser": {
...
var tty = __webpack_require__(169);
var util = __webpack_require__(131);
